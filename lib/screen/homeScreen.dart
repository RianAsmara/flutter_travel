...
import 'package:travelapp/models/beach_model.dart';
import 'package:travelapp/models/popular_model.dart';
import 'package:travelapp/models/recommended_model.dart';
import 'package:travelapp/screen/atoms/h1.dart';
import 'package:travelapp/screen/atoms/categoriesTab.dart';
import 'package:travelapp/screen/detailScreen.dart';
import 'package:travelapp/screen/organisms/header.dart';
      ...
      body: SafeArea(
        ...
        child: ListView(
          ...
          children: [
            ...
            // ListView Beach Section
            Container(
              margin: EdgeInsets.only(top: 18.8, bottom: 16.8),
              height: 124.8,
              child: ListView.builder(
